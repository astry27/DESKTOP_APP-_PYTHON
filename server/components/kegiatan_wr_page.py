# Path: server/components/kegiatan_wr_page.py
# Kegiatan WR Standalone Page Component
# Displays Kegiatan WR without tabs

from PyQt5.QtWidgets import QWidget, QVBoxLayout
from PyQt5.QtCore import pyqtSignal

# Import the actual Kegiatan WR widget
from .kegiatan_wr import KegiatanWRWidget


class KegiatanWRPageComponent(QWidget):
    """
    Kegiatan WR Standalone Page Component
    Displays the Kegiatan WR content as a standalone page without tabs
    """
    ...
    def setup_ui(self):
        """Setup UI with Kegiatan WR widget"""
        layout = QVBoxLayout(self)
        layout.setContentsMargins(0, 0, 0, 0)
        layout.setSpacing(0)

        # Create the Kegiatan WR widget
        self.kegiatan_widget = KegiatanWRWidget(self)
